...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> findAllByUserId(Long userId, Long from, Integer size) {
    ...
    public ResponseEntity<Object> searchByParams(Long userId, String text, Long from, Integer size) {
        Map<String, Object> params = Map.of(
                "text", text,
                "from", from,
                "size", size
